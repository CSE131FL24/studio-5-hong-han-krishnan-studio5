...
public class Methods {
	...
	/**
	 * Return the mean of the values filled in the given array
	 * 
	 * @param values the received array with values inside
	 * @return and return the mean of the values in the array
	 */
